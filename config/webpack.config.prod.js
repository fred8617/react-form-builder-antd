...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      'component':`${myDirPath}/component`,
  	  'tool':`${myDirPath}/tool/index.js`,
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          {
           test: /\.less$/,
           loaders: [{loader:'style-loader'}, {loader:'css-loader'}, {loader:'less-loader',options:{javascriptEnabled:true}}],
         },
