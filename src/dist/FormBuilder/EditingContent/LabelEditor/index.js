...
var LabelEditor = (0, _Context.FormConsume)(_class = function (_Component) {
  ...
  function LabelEditor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LabelEditor.__proto__ || Object.getPrototypeOf(LabelEditor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      editorState: _draftJs.EditorState.createEmpty(),
      toolbar: ['inline', 'blockType', 'fontSize', 'fontFamily',
      //'list',
      //'textAlign',
      'colorPicker', 'link',
      //'embedded',
      'emoji', 'image', 'remove', 'history']
    }, _this.setEditState = function (data) {
      ...
      var _this$props$state = _this.props.state,
          data = _this$props$state.editingData,
          setEditingData = _this$props$state.actions.setEditingData;

      var label = (0, _draftjsToHtml2.default)((0, _draftJs.convertToRaw)(editorState.getCurrentContent()));
  ...
  _createClass(LabelEditor, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var data = nextProps.state.editingData;
      var editingData = this.props.state.editingData;
